...
class Solution {
    ...
    public int solution(int[][] board) {
        ...
        while (!q.isEmpty()) {
            ...
            if ((pos.getPos1X() == n && pos.getPos1Y() == n)
                    || (pos.getPos2X() == n && pos.getPos2Y() == n)) {
            ...
            for (int i = 0; i < nextPos.size(); i++) {
                ...
                for (int j = 0; j < visited.size(); j++) {
                    if (pos.getPos1X() == visited.get(j).getPos1X()
                            && pos.getPos1Y() == visited.get(j).getPos1Y()
